...
public class VideoProvider {
    ...
    public static MediaInfo buildMediaInfo(String title, String subTitle, String studio,
        ...
        movieMetadata.addImage(new WebImage(Uri.parse(getThumbPrefix() + imgUrl)));
        movieMetadata.addImage(new WebImage(Uri.parse(getThumbPrefix() + bigImageUrl)));
